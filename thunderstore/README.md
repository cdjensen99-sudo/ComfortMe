...
3. Look at **This room: N** to the **right** of the hammer. That is vanilla comfort covering you right now (base + shelter + furniture that currently count). The list stays open with the menu.
...
| **Amber** | **Unlit** — in range, but not contributing until you add fuel / light it | — |
...
| **ComfortMe** | Which **hammer icons** would raise **this** room, plus a Comfort category and a slim room total. |
